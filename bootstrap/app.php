...
$app->routeMiddleware([
    'enc' => App\Http\Middleware\EncryptDecryptMiddleware::class,
    'webEnc' => App\Http\Middleware\WebEncryptionDecryptionMiddleware::class
]);
/*
|--------------------------------------------------------------------------
...
//        $routes = glob(__DIR__ . '/../routes/web.php');
//
